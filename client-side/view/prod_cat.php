...
<head>
	<script type="text/javascript">
		var aJaxURL	= "server-side/view/prod_cat.action.php";		//server side folder url
...
<body>
    <div id="dt_example" class="ex_highlight_row" style="width: 1024px; margin: 0 auto;">
        <div id="container">        	
            <div id="dynamic">
            	<h2 align="center">პროდუქტის სახეობა</h2>
            	<div id="button_area">
    ...
    <!-- jQuery Dialog -->
    <div id="add-edit-form" class="form-dialog" title="პროდუქტის სახეობა">
    	<!-- aJax -->
	</div>
</body>
</html>
