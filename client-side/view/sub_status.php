...
<head>
	<script type="text/javascript">
		var aJaxURL	= "server-side/view/sub_status.action.php";		//server side folder url
...
<body>
<div id="tabs">
<div class="callapp_head">შედეგის მიზეზი<hr class="callapp_head_hr"></div>
<div id="button_area">
...
<td id="show_copy_prit_exel" myvar="0"><img alt="link" src="media/images/icons/select.png" height="14" width="14">
    ...
    <!-- jQuery Dialog -->
    <div id="add-edit-form" class="form-dialog" title="შედეგის მიზეზი">
    	<!-- aJax -->
	</div>
</body>
</html>
