...
<head>
	<script type="text/javascript">
		var aJaxURL	= "server-side/view/cordinator.action.php";		//server side folder url
...
<body>
    <div id="dt_example" class="ex_highlight_row" style="width: 1024px; margin: 0 auto;">
        <div id="container">        	
            <div id="dynamic">
            	<h2 align="center">კორდინატორი</h2>
            	<div id="button_area">
    ...
    <!-- jQuery Dialog -->
    <div id="add-edit-form" class="form-dialog" title="კორდინატორი">
    	<!-- aJax -->
	</div>
</body>
</html>
