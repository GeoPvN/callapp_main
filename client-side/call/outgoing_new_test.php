...
.quest_body{
	...
	<script type="text/javascript">
	    var gela = {};
	    var next_i = 0;
		var aJaxURL		= "server-side/call/outgoing/new/outgoing_tab0_0.action.php";		//server side folder url
	 ...
	 function GetProductionInfoo(name) {
	    ...
	    $(document).on("click", "#done-dialog1", function () {
			...
			param 				= new Object();
 			...
 			param.id			= $("#id").val();
 			param.sqesi         = $("input[name=sqesi]:checked").val();
 			param.asaki         = $("input[name=asaki]:checked").val();
 		    $('#dialog-form input[name=tematika]:checked').each(function() {	
		    	
	    		inp_value    = this.value;
	    		
	    	    if(inp_value != '' && inp_value != 'undefined'){
	    	    	param.tematika      += inp_value+',';
	    	    }
	    	});
 			
 			param.tematika_inp     = $("#tematika_inp").val();
 			param.rubrika1         = $("#rubrika1").val();
 			param.rubrika2         = $("#rubrika2").val();
 			param.rubrika3         = $("#rubrika3").val();
 			param.gazeti         = $("input[name=gazeti]:checked").val();
 			param.reklama         = $("input[name=reklama]:checked").val();
 			param.yidva         = $("input[name=yidva]:checked").val();
 			param.rcheva         = $("#rcheva").val();
 			param.qalaqi         = $("#qalaqi").val();
