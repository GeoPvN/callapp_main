...
<script type="text/javascript">
    ...
    $(document).on("click", "#callapp_show_filter_button", function () {
        if($('.callapp_filter_body').attr('myvar') == 0){
        	...
        	$('#table_right_menu_content').css('top','256px');
        }else{
        	$('.callapp_filter_body').css('display','none');
        	$('.callapp_filter_body').attr('myvar',0);
        	$('#table_right_menu_content').css('top','163px');
        }        
    });
...
<div id="table_right_menu_content"></div>
...
<div id="flesh_panel">
<div class="callapp_head" style="text-align: right;">ქოლ-ცენტრი<hr class="callapp_head_hr"></div>
