...
?>
	...
	<script type="text/javascript">
		...
		var aJaxURL1	= "server-side/call/action/action.action1.php";		//server side folder url
		...
		function GetTable0() {
            LoadTable0();
            SetEvents("add_button", "delete_button", "check-all-in", "example0", fName, aJaxURL);
		 ...
		 function GetTable1() {
             ...
             LoadTable1();
             SetEvents("", "delete_button_ar", "check-all-in-archive", "example1", fName, aJaxURL);
         }
		 function LoadTable0(){			
		                ...
		                <table class="display" id="example0" style="width: 100%;">
		                    <thead>
								<tr id="datatable_header">
		                           <th>ID</th>
									<th style="width:3%;">#</th>
									<th style="width:11%; word-break:break-all;">დასაწყისი</th>
									<th style="width:11%; word-break:break-all;">დასასრული</th>
									<th style="width:17%; word-break:break-all;">დასახელება</th>
		    ...
		    <div id="dt_example" class="ex_highlight_row">
		        <div id="container" style="width: 100%;">        	
		            <div id="dynamic">
		            	...
		            	<div id="button_area">
		            		<button id="delete_button_ar">წაშლა</button>
	        			</div>
		                <table class="display" id="example1">
							...
							<thead>
								<tr class="search_header">
									...
									<th>
										<input type="checkbox" name="check-all" id="check-all-in-archive"/>
									</th>
								</tr>
							</thead>
		                </table>
