    ...
    case 'get_edit_page':
 	...
 	case 'get_list' :
	    ...
	    $columns = array(
	        ...
	        array( 'db' => 'task_date',  			'dt' => 3 ),
	        array( 'db' => 'date',                  'dt' => 4 ),
	        array( 'db' => 'start_date',     		'dt' => 5 ),
	        array( 'db' => 'end_date',	            'dt' => 6 ),
	        array( 'db' => 'task_type_name',		'dt' => 7 ),
	        array( 'db' => 'shabloni_name',	        'dt' => 8 ),
	        array( 'db' => 'first_last_name',		'dt' => 9 ),
	        array( 'db' => 'person_name',			'dt' => 10 ),
	        array( 'db' => 'call_content',		    'dt' => 11 ),
	        array( 'db' => 'note',		            'dt' => 12 ),	        
	    ...
	    */
	    ...
	    if($_REQUEST[check] != ''){
	        $dadebit = "AND `result_quest` = '$_REQUEST[check]'";
	    }else{
	        $dadebit = "";
	    }
	    
	    $where_param = "where `status` = 3 $dadebit ";
