    ...
    case 'get_edit_page':
 	...
 	case 'get_list' :
	    ...
	    $columns = array(
	        ...
	        array( 'db' => 'task_type_name',		'dt' => 6 ),
	        array( 'db' => 'shabloni_name',	        'dt' => 7 ),
	        array( 'db' => 'first_last_name',		'dt' => 8 ),
	        array( 'db' => 'person_name',			'dt' => 9 ),
	        array( 'db' => 'prio_name',		        'dt' => 10 ),
	        array( 'db' => 'note',		            'dt' => 11 ),	        
	    ...
	    */
	    ...
	    $where_param = "where `status` = 4 $user_checker ";
