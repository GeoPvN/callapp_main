	...
	<div id="dialog-form">
	    <fieldset>
	    	...
	    	<table class="dialog-form-table">
				...
				<tr>
					<td>
						<input style="width: 500px !important;" type="text" id="name" class="idle address" onblur="this.className=\'idle address\'" onfocus="this.className=\'activeField address\'" value="' . $res['name'] . '"disabled="disabled" />
					</td>
				</tr>
				<tr>
