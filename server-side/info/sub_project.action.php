	    ...
	    <fieldset style="width: 320px;  float: left;">
	       <legend>ძირითადი ინფორმაცია</legend>
			<table class="dialog-form-table">
	           ...
	           <tr>
	               <td colspan="2"><input type="text" id="project_number" style="resize: vertical;width: 300px; margin-top: 10px;"></input></td>
    	       </tr>
				<tr>
	               <td colspan="2"><label style="margin-top: 30px;" for="incomming_cat_1_1_1">რიგი</label></td>
    	       </tr>
	           <tr>
	               <td colspan="2"><select type="text" id="project_queue" style="resize: vertical;width: 300px; margin-top: 10px;"></select></td>
    	       </tr>
			</table>
		 </fieldset>
	  </div>
