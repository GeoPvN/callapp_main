...
function GetPage($res = '')
{
    ...
    $data = '
        <div id="dialog-form">
						...
						<table class="dialog-form-table">
						<tr>
						<td><textarea  style="width: 680px; height:100px; resize: none; background: #EBF9FF;" id="content" disabled class="idle" name="content" cols="300" ></textarea></td>
						</tr>
						<tr>
						...
						<tr>
						<td style="text-align:right;"><span>აქვს</span></td>
						<td><input type="radio" name="hello_quest" value="1"></td>
						<td><span>(ვაგრძელებთ)</span></td>
						</tr>
						<tr>
						<td style="text-align:right;"><span>სურს სხვა დროს</span></td>
						<td><input type="radio" name="hello_quest" value="2"></td>
						<td><span>(ვიფორმირებთ დავალებას)</span></td>
						</tr>
						<tr>
						<td style="text-align:right;"><span>არ სურს</span></td>
						<td><input type="radio" name="hello_quest" value="3"></td>
						<td><span>(ვასრულებთ)</span></td>
						</tr>
						</table>
						...
						<tr>
						<td><textarea  style="width: 680px; height:80px; resize: none;" id="hello_comment1" class="idle" name="content" cols="300" ></textarea></td>
						</tr>
						</table>
						</fieldset>
						...
						<table class="dialog-form-table">
										            ...
										            <td><input type="radio" name="result_quest1" value="1"></td>
										            </tr>
										            <tr>
										            <td style="text-align:right;"><span>არა</span></td>
										            <td><input type="radio" name="result_quest1" value="2"></td>
										            </tr>
							  						    </table>
							  						    <table class="dialog-form-table">
							  						    <tr>
								...
								<tr>
									<td><textarea  style="width: 680px; height:60px; resize: none;" id="result_comment1" class="idle" name="content" cols="300" ></textarea></td>
