...
$row_done_blank = mysql_fetch_assoc(mysql_query("	SELECT COUNT(asterisk_incomming.id) AS `count`
                                                    FROM `asterisk_incomming`
                                                    JOIN incomming_call ON asterisk_incomming.inc_id = incomming_call.id
...
//------------------------------- ტექნიკური ინფორმაცია
	...
	$data['page']['technik_info'] = '
                    ...
                    <td>'.($row_answer[count] - $row_done_blank[count]).'</td>
