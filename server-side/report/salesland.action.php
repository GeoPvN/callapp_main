	...
	case 'get_list' :
		...
		$checker = "AND incomming_call.call_type_id = $status";
	  	...
	  	$rResult = mysql_query("SELECT  		incomming_call.id,  
												...
												if(incomming_call.phone != '', incomming_call.phone, source.`name`),
								...
								WHERE 			incomming_call.actived = 1 and DATE(date)  BETWEEN  date('$start')  And date('$end') AND department.`name` = 'Readersland' $checker");
